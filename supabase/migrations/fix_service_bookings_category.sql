-- Fix for the "column category of relation service_bookings does not exist" error
-- This migration drops and recreates the booking transaction function with the corrected version

-- First, drop the existing function
DROP FUNCTION IF EXISTS create_booking_with_wallet_update;

-- Recreate the function without the problematic category column reference
...
GRANT EXECUTE ON FUNCTION create_booking_with_wallet_update TO authenticated, service_role;
